...

{
      ...
      description:
       "A story told with pictures and animations & Still in Progress project. GitHub Link is <a href='https://github.com/MashiGitCat/The-Biggest-Shine.git' target='_blank'>https://github.com/MashiGitCat/The-Biggest-Shine.git</a>",
